...
describe("PSP Proxy Route", () => {
  ...
  describe("SSRF Protection", () => {
    ...
    it("allows valid path segments", async () => {
      ...
      const request = new NextRequest("http://localhost/api/proxy/psp/agentic_commerce/delegate_payment");
      const params = { params: Promise.resolve({ path: ["agentic_commerce", "delegate_payment"] }) };
