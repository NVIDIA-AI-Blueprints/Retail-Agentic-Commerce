...
/**
 * PSP (Payment Service Provider) API Proxy Route
 *
 * Proxies requests to the PSP API with server-side authentication.
 ...
 * Preserves any base path prefix in the PSP_API_URL.
 */
